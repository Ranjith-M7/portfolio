...
const Home = () => {
  return (
    <div
      name="home"
      className="w-full min-h-screen bg-black pt-0 md:mt-[-80px]"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center min-h-screen md:flex-row px-4 gap-8">
